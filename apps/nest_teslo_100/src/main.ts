...
// hay decoradores pipes que deé sueltos, revisar el .entity y el create.dto
...
// probar conexión sin env vars solo hardcodeado, instalar pnpm i pg o mysql2 o el driver que diga el error
